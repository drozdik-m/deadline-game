...
/// <summary>
/// Class represents UI for persistent item stage
/// </summary>
public class PersistentItemUI : BuildableObjectUI
{
    /// <summary>
    ...
    /// </summary>
    private PersistentItemStage consumeItemStageComponent;
    ...
    public void SetUI(GameObject buildableObject, Text state, RectTransform backgroundImagesPanel)
    {
        ...
        consumeItemStageComponent = buildableGameObject.GetComponentInChildren<PersistentItemStage>();
